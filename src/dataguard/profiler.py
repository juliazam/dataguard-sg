...
def profile_dataset(df: pd.DataFrame, output_path: str) -> None:
    ...
    profile = ProfileReport(df, title="DataGuard SG — Open Payments 2024", explorative=True)
...
if __name__ == "__main__":
    ...
    output_path = Path(__file__).parent.parent.parent / settings["pipeline"]["reports_path"]

...
@pytest.mark.parametrize("rows_fetched, rows_valid, rows_invalid, expected_reconciled", [
    (100, 90, 10, True),
    (100, 90, 5, False),
    (0, 0, 0, True),
    (1000, 980, 20, True)
])
def test_reconcile_parametrized(rows_fetched, rows_valid, rows_invalid, expected_reconciled):
